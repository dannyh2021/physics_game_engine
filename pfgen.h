...
public:
    ...
    /** Clears all registratinos from the registry.
     * This will not delete the particles or the force generators themselves, just the records of their connect. */
    void clear();
...
/** A force generetor that applies a drag force. One instance can be used for multiple particles. */
...
class ParticleBungee : public ParticleForceGenerator {
    /** The particle on the other end of the spring. */
    Particle *other;
...
{
    /** The location of the anchored end of the spring. */ Vector3 *anchor;
    /** Holds the spring constant. */ real springConstant;
    /** Holds the damping on the oscillation of the spring. */ real damping;

public:
    /** Creates a new spring with the given parameters. */ ParticleFakeSpring(Vector3 *anchor, real springConstant,
                                                                              real damping);
    /** Applies the spring force to the given particle. */
    virtual void updateForce(Particle *particle, real duration);
};