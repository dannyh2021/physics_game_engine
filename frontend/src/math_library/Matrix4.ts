// will probably rewrite this in the near future.
...
/**
 * Returns a project matrix that converts from world space to clip space
 */
export function projection(width: number, height: number, depth: number): numbers[] {
